...
import { createCollectionSchema, updateCollectionSchema, addItemSchema, collectionIdParamsSchema, removeItemParamsSchema, } from "./collections.validators.js";
import { create, list, getById, update, deleteCollection, addItem, removeItem, } from "./collections.controller.js";
const router = Router();
